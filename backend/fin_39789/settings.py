"""
Django settings for fin_39789 project.
...
WSGI_APPLICATION = 'fin_39789.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fin_39789 API",
    "DESCRIPTION": "API documentation for fin_39789 App",
    "VERSION": "v1",
}
